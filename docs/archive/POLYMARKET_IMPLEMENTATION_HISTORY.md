# Polymarket Prediction Markets Implementation History

> Archived implementation note from the original feature branch.

**Status at archive time:** core ingest implemented, follow-up hardening remained
**Created:** 2026-03-21
**Original branch:** `feature/prediction-markets`
...
### 1. Secret-manager / TSDB access note

This historical implementation work assumed that TimescaleDB credentials would
be provided by the maintainer's own secret-manager setup. The repo docs now
avoid embedding maintainer-specific secret-manager paths.
